...
*/
	...
	for(var idx=0;idx<NUM_COLORS;idx++){
			var rval=cp['r']['mu']-cp['r']['sigma']+idx*2*cp['r']['sigma']/NUM_COLORS;
			var gval=cp['g']['mu']-cp['g']['sigma']+idx*2*cp['g']['sigma']/NUM_COLORS;
			var bval=cp['b']['mu']-cp['b']['sigma']+idx*2*cp['b']['sigma']/NUM_COLORS;
			var A_CHANNEL=255;
