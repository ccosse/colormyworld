	...
	<div class="column" id="column2">\
		<div class="card">\
			<div id="container2" class="container container2">\
				...
				<hr/>\
				<button class="ccbutton" onclick="colorcfg.newSequenceCB()">New Sequence</button>\
				<button class="ccbutton" onclick="colorcfg.resetCB()">Reset</button>\
			</div>\
		</div>\
	</div>\
\
</div>\
<button class="ccbutton" id="doneB" onclick="colorcfg.doneCB()">Done</button>\
</div>';
